        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    if (too_close == true)
                    {
                        ...
                        for (int i =0; i<sensor_fusion.size(); i++)
                        {
                            ...
                            if((d>0) && (d<2+4*lane-2) && (abs(check_car_s-end_path_s)<30))
                            {
                                ...
                                std::cout<< "not safe to turn left!" << endl;
                            }
                            ...
                            if((d>0) && (d>2+4*lane+2) && (abs(check_car_s-end_path_s)<30))
                            {
                                ...
                                std::cout<< "d: " << d << endl;
                                std::cout<< "s diff: " << s - car_s<< endl;
                                std::cout<< "not safe to turn right!" << endl;
                            }
                        }
                        //change to left lane if clear
                        if (safe_to_change_left)
                        {
                            lane = lane -1;
                        }
                        //if left lane is not safe, switch to right lane
                        else if (safe_to_change_right)
                        {
                            lane = lane +1;
                        }
                        else
                    ...
                    if (prev_size < 2)
                    {
                        //calculate the previous position of the car
                    ...
                    {
                        //last 2 points of the previous path
                    ...
                    //calculate how to break spline points so as to travel at desired velocity
                    double target_x = 30;
